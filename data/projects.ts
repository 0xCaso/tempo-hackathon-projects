...
export const projects: ProjectDefinition[] = [
  ...
  {
    name: "daytona-mpp",
    description: "Use MPP to create daytona.io sandbox environments and execute code generated by your LLM",
    githubUrl: "https://github.com/jessepinkman9900/daytona-mpp",
    demoUrl: "https://daytona-sandbox-mpp.cnvlabs.workers.dev/llms.txt",
    category: "ai-agents",
  }
];
